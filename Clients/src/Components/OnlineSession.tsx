...
import { X, Video, Calendar, Clock, Users, Link, BookOpen, Globe } from 'lucide-react';
...
const OnlineSession: React.FC<OnlineSessionProps> = ({ onlineSession, setOnlineSession }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // submission  
    console.log('Online session scheduled:', formData);
        ...
        >
           ...
           <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              />
               ...
               <p className="text-center italic flex gap-2 ">
                {" "}
                <Users size={18} /> Online sessions support up to 250
                participants
              </p>
            ...
            <div className="sticky bottom-0 bg-white dark:bg-gray-800 pb-2 border-t border-gray-200 dark:border-gray-700">
              <button
                type="submit"
                className="cursor-pointer w-full bg-gradient-to-r from-blue-600 to-purple-700 text-white py-4 rounded-xl hover:from-blue-700 hover:to-purple-800 transition-all duration-200 transform hover:font-semibold text-lg"
              >
                Schedule Online Session
              </button>
            </div>
