  ...
  return (
    <div className="grid grid-cols-1 gap-4">
      {sessions.map((session) => (
        <div key={session._id} className="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex items-center justify-between mt-4">
            <div className="flex flex-col gap-3">
               <div className="flex items-center gap-6 text-sm text-gray-600 dark:text-gray-300">
                ...
                <div className="flex items-center gap-2">
                  <Clock size={16} />
                  <p>{formatDate(session.meetingDate)} • <span className='bg-green-700 rounded px-2 text-green-200'>{session.meetingTime}</span></p>
                </div>
