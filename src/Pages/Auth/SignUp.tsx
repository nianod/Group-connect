    ...
    <section className="bg-white dark:bg-[rgb(31,31,59)] h-screen transition-colors duration-500">
      <div className="flex h-full items-center justify-center">
        <div className="flex flex-col items-center gap-5 lg:justify-start">
          <div className="transition-colors duration-500 border border-gray-700 bg-gray-900 text-gray-100 dark:bg-gray-50 dark:text-gray-900 flex w-full max-w-xl flex-col items-center gap-y-4 rounded-xl px-8 py-7 shadow-lg">
            ...
            <form onSubmit={submit} className="w-full flex flex-col gap-3">
              ...
              <button
                disabled={loading}
                type="submit"
                className={`w-full bg-white text-black dark:bg-gray-900 dark:text-white rounded-md py-2 font-semibold text-sm hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors duration-500 ${
          ...
          <div className="text-muted-foreground flex justify-center gap-1 text-sm text-gray-600 dark:text-gray-400">
            <p>
              Already a user?{" "}
              <Link className="text-black dark:text-white" to="/login">
                Login
              </Link>
            </p>
          </div>
